 ...
 * @author Juan
 */
public class InterfazGraficaPRUEBAS extends javax.swing.JFrame {
    ...
    private void bottonDesconectarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bottonDesconectarActionPerformed
        try {
            ...
            Logger.getLogger(InterfazGraficaPRUEBAS.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazGraficaPRUEBAS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazGraficaPRUEBAS().setVisible(true);
            }
        });
    }
