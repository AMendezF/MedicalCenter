...
public class main {
    ...
    public static void main(String[] args) throws SQLException {
        char[] cPassword = {'g', 'e', 's', 't', 'o', 'r'};
        Gestor gestor = new Gestor(new Conexion("Gestor", cPassword));

        String[] horario = gestor.getHorarioEspecialidadByDay("Urología", "Lunes");

        for (String turno : horario) {
            System.out.println(turno);
        }

        ResultSet resultSet = gestor.mostrarMedicosByHorarioEspecialidad("Urología", "Mañana");
